...
describe CustomAttributesController do
  ...
  describe "GET index" do
    let(:custom_attribute_1) { FactoryGirl.create(:custom_attribute, name: "hoge") }
    let(:custom_attribute_2) { FactoryGirl.create(:custom_attribute, name: "custom_attribute_2") }
    let(:custom_attribute_3) { FactoryGirl.create(:custom_attribute, name: "custom_attribute_3") }
  ...
  describe "GET show" do
    let(:custom_attribute) { FactoryGirl.create(:custom_attribute) }
    before do
      custom_attribute
      get :show, id: custom_attribute.id, format: :json
    end
  ...
  describe "GET edit" do
    ...
    before do
      custom_attribute
      get :edit, id: custom_attribute.id
    end
  ...
  describe "POST create" do
    describe "with valid attributes" do
      ...
      it { expect { post :create, custom_attribute: attributes }.to change(CustomAttribute, :count).by(1) }
      it "assigns a newly created custom_attribute as @custom_attribute" do
        post :create, custom_attribute: attributes
    ...
    describe "with invalid attributes" do
      ...
      it { expect { post :create, custom_attribute: attributes }.not_to change(CustomAttribute, :count) }
  ...
  describe "PUT update" do
    let(:custom_attribute) { FactoryGirl.create(:custom_attribute, name: "custom_attribute") }
    before do
      custom_attribute
      put :update, id: custom_attribute.id, custom_attribute: attributes
    end
    describe "with valid attributes" do
    ...
    describe "with invalid attributes" do
      let(:attributes) { {name: ""} }
      before { allow(custom_attribute).to receive(:update_attributes).and_return(false) }
      it { expect(assigns(:custom_attribute)).to eq custom_attribute }
      it { expect(assigns(:custom_attribute).name).to eq attributes[:name] }
  ...
  describe "DELETE destroy" do
    ...
    it { expect { delete :destroy, id: custom_attribute.id }.to change(CustomAttribute, :count).by(-1) }
  end
