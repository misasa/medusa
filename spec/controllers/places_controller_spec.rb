...
describe PlacesController do
  ...
  describe "GET index" do
    ...
    let(:specimen_1) { FactoryBot.create(:specimen, name: "hoge", place_id: place_1.id) }
    let(:specimen_2) { FactoryBot.create(:specimen, name: "specimen_2", place_id: place_2.id) }
    let(:specimen_3) { FactoryBot.create(:specimen, name: "specimen_3", place_id: place_3.id) }
