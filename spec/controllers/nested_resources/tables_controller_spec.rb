...
describe NestedResources::TablesController do
  ...
  describe "POST create" do
    let(:method) { post :create, params: { parent_resource: parent_name, bib_id: parent, table: attributes }}
    before { child }
  ...
  describe "PUT update" do
    let(:method) { put :update, params: { parent_resource: parent_name, bib_id: parent, id: child_id, association_name: :bibs }}
  ...
  describe "DELETE destory" do
    let(:method) { delete :destroy, params: { parent_resource: parent_name, bib_id: parent, id: child_id, association_name: :bibs}}
    let(:child_id) { child.id }
  ...
  describe "POST link_by_global_id" do
    ...
    context "occur raise" do
      ...
      context "format html" do
        before do
          post :link_by_global_id, params: { parent_resource: parent_name, bib_id: parent.id, global_id: child.global_id, format: :html }
        end
      ...
      context "format json" do
        before do
          post :link_by_global_id, params: { parent_resource: parent_name, bib_id: parent.id, global_id: child.global_id, format: :json }
        end
