...
describe NestedResources::AttachmentFilesController do
  ...
  describe "GET index", :current => true do
    ...
    context "with format json" do
      let(:method){get :index, params: { parent_resource: parent_name, bib_id: parent, association_name: :attachment_files, format: 'json'}}
      before {
  ...
  describe "POST create" do
    let(:method){post :create, params: { parent_resource: parent_name, bib_id: parent, attachment_file: attributes }}
    before{child}
  ...
  describe "PUT update" do
    let(:method){put :update, params: { parent_resource: parent_name, bib_id: parent, id: child_id, association_name: :attachment_files }}
