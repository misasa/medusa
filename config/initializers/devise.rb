...
Devise.setup do |config|
  ...
  config.secret_key = 'a3625da20c334f739927db19924629cf50d605b5c3d23a9793bbc1de53d0a687fbf6d7c3e60bab3c7640a92c1fded080189167d0baf8f0f9f47df190ddae0c61'
  ...
  # config.pepper = '83e8c36e981a7a89d4c9719e2f39632728858bd4ae0f41f0a34748930621c7d3c0be4d640eb0916c355e52239e558fced5c10983d4bd36c9f0937fa8d40def84'
  ...
  if File.exists?(Rails.root.join("config/google.yml"))
    # google_config = YAML.load_file(Rails.root.join("config/google.yml"))
    google_config = ActiveSupport::ConfigurationFile.parse(Rails.root.join("config/google.yml"))
